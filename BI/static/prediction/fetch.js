...
$(document).ready(()=>{
    ...
    function displayChart(data){
        ...
        msetrain_li.appendChild(document.createTextNode(`MSE for train data: ${data.mse_train}`));
        msetest_li.appendChild(document.createTextNode(`MSE for test data: ${data.mse_test}`));
